...
Options:
  ...
  --eta=<eta>               eta - ratio of R1/R2 [default: 0.9]
...
suffix = "Gr_" + str(Gr) + "_mu_" + str(mu) + "_m_" + str(int(m))
...
fig.savefig('tc_crit_ef_1d_' + suffix + '.png')
...
dir_name = "crit_ef"
print(dir_name)
ep.write_global_domain(fieldsys, base_name=dir_name)
