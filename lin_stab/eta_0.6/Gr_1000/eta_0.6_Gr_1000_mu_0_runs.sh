...
# nproc=8
# mpirun -np ${nproc} python3 tc_r_heat_aw_stability.py --Pr=1 --eta=0.6 --Gr=1000 --mu=0 --m=0 --Ta_range='3200, 3600' --kz_range='0.1, 6' --nr=64 --nTa=40 --nkz=40 --heated=1 >> logfiles/neutral_stab_aw_Gr_1000_Pr_1_eta_0.6_mu_0_m_0.log
# mpirun -np ${nproc} python3 tc_r_heat_aw_stability.py --Pr=1 --eta=0.6 --Gr=1000 --mu=0 --m=-1 --Ta_range='1000, 3200' --kz_range='0.1, 5' --nr=64 --nTa=40 --nkz=40 --heated=1 >> logfiles/neutral_stab_aw_Gr_1000_Pr_1_eta_0.6_mu_0_m_-1.log
# mpirun -np ${nproc} python3 tc_r_heat_aw_stability.py --Pr=1 --eta=0.6 --Gr=1000 --mu=0 --m=-2 --Ta_range='1500, 3500' --kz_range='0.1, 6' --nr=64 --nTa=40 --nkz=40 --heated=1 >> logfiles/neutral_stab_aw_Gr_1000_Pr_1_eta_0.6_mu_0_m_-2.log
# mpirun -np ${nproc} python3 tc_r_heat_aw_stability.py --Pr=1 --eta=0.6 --Gr=1000 --mu=0 --m=-3 --Ta_range='1500, 4000' --kz_range='0.1, 6' --nr=64 --nTa=40 --nkz=40 --heated=1 >> logfiles/neutral_stab_aw_Gr_1000_Pr_1_eta_0.6_mu_0_m_-3.log
# mpirun -np ${nproc} python3 tc_r_heat_aw_stability.py --Pr=1 --eta=0.6 --Gr=1000 --mu=0 --m=-4 --Ta_range='82000, 90000' --kz_range='5, 10' --nr=64 --nTa=40 --nkz=40 --heated=1 >> logfiles/neutral_stab_aw_Gr_1000_Pr_1_eta_0.6_mu_0_m_-4.log
#------------------------------------
# params
nproc=8
Pr=1
...
mpirun -np ${nproc} python3 tc_r_heat_aw_stability.py --Pr=${Pr} --eta=${eta} --Gr=${Gr} --mu=${mu} --m=-2 --Ta_range='1e3, 1e5' --kz_range='1, 20' --nr=${nr} --nTa=${nTa} --nkz=${nkz} --heated=1 >> logfiles/neutral_stab_aw_Gr_${Gr}_Pr_${Pr}_eta_${eta}_mu_${mu}_m_-2.log
...
# mpirun -np ${nproc} python3 tc_r_heat_aw_stability.py --Pr=${Pr} --eta=${eta} --Gr=${Gr} --mu=${mu} --m=-4 --Ta_range='1e3, 4e5' --kz_range='1, 20' --nr=${nr} --nTa=${nTa} --nkz=${nkz} --heated=1 >> logfiles/neutral_stab_aw_Gr_${Gr}_Pr_${Pr}_eta_${eta}_mu_${mu}_m_-4.log
