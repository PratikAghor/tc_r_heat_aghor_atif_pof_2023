...
#------------------------------------
# echo 'mu =' ${mu} ' , m = -3 \n' 
# python3 sigma_vs_k_tc_r_heat_aw.py --Pr=${Pr} --eta=${eta} --mu=${mu} --Gr=${Gr} --m=-3 --Ta_range='10, 1e5' --kz_range='0.1, 10' --nr=${nr} --nTa=${nTa} --nkz=${nkz} --heated=1 >> logfiles/sigma_vs_k_aw_Gr_${Gr}_Pr_${Pr}_eta_${eta}_mu_${mu}_m_-3.log
# printf '############################################################################# \n' >> logfiles/sigma_vs_k_aw_Gr_${Gr}_Pr_${Pr}_eta_${eta}_mu_${mu}_m_-3.log
# #------------------------------------

# echo 'mu =' ${mu} ' , m = -4 \n' 
# python3 sigma_vs_k_tc_r_heat_aw.py --Pr=${Pr} --eta=${eta} --mu=${mu} --Gr=${Gr} --m=-4 --Ta_range='10, 1e5' --kz_range='0.1, 10' --nr=${nr} --nTa=${nTa} --nkz=${nkz} --heated=1 >> logfiles/sigma_vs_k_aw_Gr_${Gr}_Pr_${Pr}_eta_${eta}_mu_${mu}_m_-4.log
